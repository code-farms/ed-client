...
const features = [
  {
    title: "PDF to Word",
    description:
      "Convert PDF documents to editable Word files quickly and accurately.",
    icon: FileText,
...
export const Home: React.FC = () => {
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="pb-4 px-4 -mx-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
            Convert, merge, split, and compress your files with our powerful
            online tools. Fast, secure, and free to use.
          </p>
        </div>
      </section>
